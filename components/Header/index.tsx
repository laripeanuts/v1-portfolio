...
export const Header = ({}: HeaderProps) => {
  return (
    <motion.header className="sticky top-0 p-4 flex flex-row items-center justify-between max-w-7xl mx-auto">
      <motion.div
      ...
      <div className="uppercase text-sm text-zinc-400 flex flex-row items-center">
        <SocialIcon
          network="email"
