...
export const About = ({ profile }: AboutProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-between h-[70vh] gap-4 mt-20 md:mt-10 md:flex-row md:p-10 md:gap-10">
      <Image
        ...
        priority
      />
      <div className="flex flex-col justify-between h-screen max-h-[40vh] gap-4 md:gap-4">
        ...
        <p className="text-xs md:text-sm leading-normal overflow-y-scroll overflow-x-hidden scrollbar-thin scrollbar-track-zinc-900 scrollbar-thumb-primary h-screen md:max-h-[280px] text-left">
